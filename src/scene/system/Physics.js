...
Pxl.Physics = function() {
  ...
  this.componentTypes = [Pxl.PhysicsComponent];
  this.collisionPairs = [];
...
Pxl.Physics.prototype = Object.create(Pxl.System.prototype);
Pxl.Physics.prototype.constructor = Pxl.Physics;

Pxl.Physics.prototype.onAddedToScene = function(event) {
...
Pxl.Physics.prototype.onSceneUpdated = function(event) {
  // update location
  var key;
...
Pxl.Physics.prototype.addCollisionPair = function(typeOne, typeTwo) {
  ...
  if (!pairFound) {
    this.collisionPairs.push(new Pxl.CollisionPair(typeOne, typeTwo));
