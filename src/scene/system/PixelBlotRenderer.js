Pxl.PixelBlotRenderer = function() {
  ...
  this.componentTypes = [Pxl.PixelBlotMap];
  this.pixelBlotMaps = [];
...
Pxl.PixelBlotRenderer.prototype = Object.create(Pxl.System.prototype);
Pxl.PixelBlotRenderer.prototype.constructor = Pxl.PixelBlotRenderer;

Pxl.PixelBlotRenderer.prototype.onAddedToScene = function(event) {
